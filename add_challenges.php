...
if (isset($_POST['save'])) {
   ...
   if($type=='1')
    ...
    $query = "INSERT INTO challenges(question,level, algorithm_id, type, answer_a,
     ...
     VALUES ('$q','$level','$algorithm_id','$type','$answer_a','$answer_b','$answer_c',' $correct_answer','$feedback_a','$feedback_b','$feedback_c')";
...
$answer = $_POST['answer_true_fals'];
     ...
     VALUES ('$q','$level','$algorithm_id','$type','$answer','$feedback_true',' $feedback_false')";
  if ($con->query($query) === TRUE) {
  ...
  <body class="sub_page" dir="ltr">
    ...
    <section class="serv">
      <div class="container">
        ...
        <div class="content">
          <form  method="post" action="add_challenges.php" enctype="multipart/form-data">
            <div class="">
              ...
              <div class="input-box ">
                ...
                <input type="text" class="form-control form-control-sm" placeholder="Question"  name="q"  class="full" />
                <div id="Question"></div>
              </div>
              <div id="QuestionType"> 
        ...
        $(".full").change(function(){
          var questionType=$(".full").val();
            if(questionType=="2"){
              ...
              // $("#QuestionType").hide(1000);
//               $("#Feedback").hide(1000);
//               $("#True").remove();
//               $("#False").remove();
//               var newElement=$("#Question");
//             
//               var Keys = document.createElement("input");
//                         Keys.setAttribute("type", "text");
//                         Keys.setAttribute("id", `Keys`);
//                         Keys.setAttribute("name", `Keys`);
//                         Keys.setAttribute("class", `form-control form-control-sm`);
//                         Keys.setAttribute("placeholder", ` key`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(Keys);
//                         
//                         var Answers = document.createElement("input");
//                         Answers.setAttribute("type", "text");
//                         Answers.setAttribute("id", `Answers`);
//                         Answers.setAttribute("name", `Answers`);
//                         Answers.setAttribute("class", `form-control form-control-sm`);
//                         Answers.setAttribute("placeholder", `Answer`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(Answers);
// 
//                          
...
//                         Feedback.setAttribute("class", `form-control form-control-sm`);
//                         Feedback.setAttribute("placeholder", `Feedback`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(Feedback);
// 
...
//                         True.setAttribute("id", `True`);
//                         True.setAttribute("name", `Answer`);
//                         True.setAttribute("class", `form-control form-control-sm`);
//                         True.setAttribute("placeholder", `True`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(True);
//                         
// 
//                         var FeedbackTrue = document.createElement("input");
//                         FeedbackTrue.setAttribute("type", "text");
//                         FeedbackTrue.setAttribute("id", `FeedbackTrue`);
//                         FeedbackTrue.setAttribute("name", `FeedbackTrue`);
//                         FeedbackTrue.setAttribute("class", `form-control form-control-sm`);
//                         FeedbackTrue.setAttribute("placeholder", `Feedback true`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(FeedbackTrue);
//                         
// 
//                         var False = document.createElement("input");
//                         False.setAttribute("type", "radio");
//                         False.setAttribute("id", `False`);
//                         False.setAttribute("name", `Answer`);
//                         False.setAttribute("class", `form-control form-control-sm form-check-input`);
//                         False.setAttribute("placeholder", `False`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(False);
// 
//                         var Feedback = document.createElement("input");
//                         Feedback.setAttribute("type", "text");
//                         Feedback.setAttribute("id", `Feedback`);
//                         Feedback.setAttribute("name", `FeedbackFalse`);
//                         Feedback.setAttribute("class", `form-control form-control-sm`);
//                         Feedback.setAttribute("placeholder", `Feedback False`);
//                         var addAfterMaritalStatus = document.getElementById("Question");
//                         addAfterMaritalStatus.appendChild(Feedback);
// 
                      ...
                      //  $("#WRITE").show(1000);
                        ...
                        // $("#Keys").remove();
                        // 
                        // $("#True").hide(1000).remove();
                        // $("#False").hide(1000).remove();
                        // $("#QuestionType").show(1000);
                        }
