   ...
   .button { width: 200px; padding: 15px 10px; text-align: center ; margin:20px 10px; border-radius: 25px; font-weight: bold; border: 2px solid #1999cc; background: transparent ; color: rgb(11, 11, 11); cursor: pointer; position: relative; overflow: hidden; }
    ...
    <div class="banner" >
        ...
        <div class="content">
            ...
            <a href="add_video.php" class="button">Add New Video<span class="span"></span></a>
            <a href="add_challenge.php" class="button">Add New Challenge<span class="span"></span></a>
            <a href="index2.php" class="button">Add ALgorithm<span class="span"></span></a>
            <a href="customerMessages.php" class="button">customer messages<span class="span"></span></a>
